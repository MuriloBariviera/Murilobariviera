    ...
    <form action="../controller/Product.php" method="POST">
        <section class="mx-4 mt-4 columns-3">
            <article>
                ...
                <input type="number" name="barCode" id="barCode" class="border border-purple-400" required>
            </article>
            <article>
                <label for="name" class="cursor-pointer">Nome do produto: </label>
                <input type="text" id="name" name="name" class="border border-purple-400" required>
            </article>
            <article>
        ...
        <section class="mx-4 mt-4 columns-2">
            <article>
                ...
                <input type="number" name="quantity" id="quantity" class="border border-purple-400" required min=1 max=1000>
            </article>
            <article>
                <label for="cost" class="cursor-pointer">Custo de aquisição: </label>
                <input type="number" name="cost" id="cost" class="border border-purple-400" required min=1 max=10000>
            </article>
        </section>
